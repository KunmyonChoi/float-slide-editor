 ...
 */
export default function ChromaVideoPlayer({ content, playNow, autoplay, loop, muted, hideControls, objectFit, objectPosition, chroma, radius }) {
  ...
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative' }}>
      <canvas
        ...
        style={{ width: '100%', height: '100%', objectFit: objectFit || 'contain', objectPosition, display: 'block', borderRadius: radius, pointerEvents: 'none' }}
      />
      <video
        ref={videoRef}
        src={blobUrl}
