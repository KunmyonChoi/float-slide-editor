...
- 캔버스 기본값 **1280×720**(16:9). `<body>`와 각 `.slide`의 width/height를 동일하게.
...
<meta charset="UTF-8">
<title>Deck</title>
<!-- 웹폰트가 필요하면 여기 link. 예: Pretendard / Google Fonts -->
...
<body>
  ...
  <div class="slide active" style="width:1280px;height:720px;background:#0f172a;">
    <!-- 요소들 -->
  </div>

  <div class="slide" style="width:1280px;height:720px;background:#0f172a;">
    <!-- 다음 장 요소들 -->
  </div>
...
```html
<div style="position:absolute;left:80px;top:90px;width:1120px;height:120px;
            font-family:'Noto Sans KR',sans-serif;font-size:64px;font-weight:900;
...
```html
<div style="position:absolute;left:80px;top:240px;width:520px;height:300px;
...
<div style="position:absolute;left:80px;top:240px;width:520px;height:160px;
            ...
            font-family:'Noto Sans KR',sans-serif;font-size:24px;color:#e2e8f0;text-align:center;">
  카드 본문 텍스트
</div>
```
...
```html
<div style="position:absolute;left:80px;top:430px;width:1120px;height:90px;
            font-size:28px;color:#cbd5e1;line-height:1.5;">
...
```html
<div style="position:absolute;left:80px;top:240px;width:1120px;height:300px;
            font-size:30px;color:#e2e8f0;line-height:1.8;">
...
- 캔버스는 **1280×720**(원하면 1920×1080 등으로 통일, 단 body·slide·요소 좌표를 모두 그 기준으로).
- 안전 여백 ~80px. 요소끼리 겹치지 않게, px로 직접 레이아웃(그리드를 머릿속으로 계산).
...
<body>
  ...
  <div class="slide active" style="width:1280px;height:720px;background:linear-gradient(135deg,#0f172a,#1e293b);font-family:'Noto Sans KR',sans-serif;">
    <div style="position:absolute;left:80px;top:240px;width:1000px;height:140px;font-size:72px;font-weight:900;color:#f8fafc;line-height:1.05;">2026 1분기 리뷰</div>
    <div style="position:absolute;left:80px;top:400px;width:900px;height:60px;font-size:28px;color:#94a3b8;">성장 지표와 다음 분기 방향</div>
    <div style="position:absolute;left:80px;top:120px;width:64px;height:8px;background:#818cf8;border-radius:4px;"></div>
  </div>

  <div class="slide" style="width:1280px;height:720px;background:#0f172a;font-family:'Noto Sans KR',sans-serif;">
    <div style="position:absolute;left:80px;top:80px;width:1120px;height:70px;font-size:48px;font-weight:900;color:#f8fafc;">핵심 지표</div>
    <div style="position:absolute;left:80px;top:200px;width:360px;height:240px;background:#1e293b;border:1px solid rgba(255,255,255,0.1);border-radius:20px;display:flex;flex-direction:column;align-items:center;justify-content:center;color:#818cf8;font-size:56px;font-weight:900;">+38%</div>
    <div style="position:absolute;left:80px;top:460px;width:360px;height:50px;font-size:22px;color:#cbd5e1;text-align:center;">매출 성장</div>
    <div style="position:absolute;left:460px;top:200px;width:360px;height:240px;background:#1e293b;border:1px solid rgba(255,255,255,0.1);border-radius:20px;display:flex;align-items:center;justify-content:center;color:#34d399;font-size:56px;font-weight:900;">12.4k</div>
    <div style="position:absolute;left:460px;top:460px;width:360px;height:50px;font-size:22px;color:#cbd5e1;text-align:center;">신규 사용자</div>
    <div style="position:absolute;left:840px;top:200px;width:360px;height:240px;background:#1e293b;border:1px solid rgba(255,255,255,0.1);border-radius:20px;display:flex;align-items:center;justify-content:center;color:#f472b6;font-size:56px;font-weight:900;">96%</div>
    <div style="position:absolute;left:840px;top:460px;width:360px;height:50px;font-size:22px;color:#cbd5e1;text-align:center;">유지율</div>
  </div>
